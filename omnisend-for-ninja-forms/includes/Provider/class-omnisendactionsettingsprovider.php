	...
	private function get_heading_settings(): array {
		return array(
			'weclome_email_block'                   => array(
				...
				'type'           => 'html',
				'group'          => 'advanced',
				'label'          => esc_html__( 'This is a message', 'omnisend-for-ninja-forms' ),
				'value'          => '<h2 class="omnisend-ninja-forms-block-heading omnisend-ninja-forms-form-top">' . esc_html__( 'Welcome email', 'omnisend-for-ninja-forms' ) . '</h2>',
				'width'          => 'full',
				'use_merge_tags' => true,
			),
			'message'                               => array(
				...
				'group'          => 'advanced',
				'label'          => esc_html__( 'This is a message', 'omnisend-for-ninja-forms' ),
				'value'          => '<p class="omnisend-ninja-forms-text">' . esc_html__( 'Use this to automatically send your custom welcome email, created in Omnisend, to subscribers joining through Ninja forms.', 'omnisend-for-ninja-forms' ) . '</p>',
				'width'          => 'full',
				'use_merge_tags' => true,
			),
			self::SEND_WELCOME_EMAIL                => array(
				...
				'type'  => 'toggle',
				'group' => 'advanced',
				'label' => esc_html__( 'Send a welcome email to new subscribers ', 'omnisend-for-ninja-forms' ),
				'width' => 'full',
			),
			'welcoming_learn_more'                  => array(
				...
				'group'          => 'advanced',
				'label'          => esc_html__( 'This is a message', 'omnisend-for-ninja-forms' ),
				'value'          => '<div class="omnisend-ninja-forms-block-end"><a href="https://support.omnisend.com/en/articles/1061818-welcome-email-automation" target="_blank" class="omnisend-ninja-forms-link">' . esc_html__( 'Learn more about Welcome automation', 'omnisend-for-ninja-forms' ) . '</a></div>',
				'width'          => 'full',
				'use_merge_tags' => true,
			),
			'field_mapping_block'                   => array(
				...
				'group'          => 'advanced',
				'label'          => esc_html__( 'This is a message', 'omnisend-for-ninja-forms' ),
				'value'          => '<h2 class="omnisend-ninja-forms-block-heading">' . esc_html__( 'Field mapping', 'omnisend-for-ninja-forms' ) . '</h2>',
				'width'          => 'full',
				'use_merge_tags' => true,
			),
			'field_mapping_message'                 => array(
				...
				'group'          => 'advanced',
				'label'          => esc_html__( 'This is a message', 'omnisend-for-ninja-forms' ),
				'value'          => "<p class='omnisend-ninja-forms-text'>" . esc_html__( "Field mapping lets you align your form fields with Omnisend. It's important to match them correctly, so the information collected through Ninja Forms goes into the right place in Omnisend", 'omnisend-for-ninja-forms' ) . '</h4>',
				'width'          => 'full',
				'use_merge_tags' => true,
			),
			'field_mapping_dont_see_fields_trouble' => array(
				...
				'group'          => 'advanced',
				'label'          => esc_html__( 'This is a message', 'omnisend-for-ninja-forms' ),
				'value'          => "<div class='omnisend-ninja-forms-updated-fields-heading'>" . esc_html__( 'Don\'t see updated fields?', 'omnisend-for-ninja-forms' ) . "<a class='omnisend-ninja-refresh-page-link-link' href='#' onclick='window.location.reload();'>" . esc_html__( 'Refresh page', 'omnisend-for-ninja-forms' ) . '</a></div>',
				'width'          => 'full',
				'use_merge_tags' => true,
			),
			'field_mapping_having_trouble'          => array(
				...
				'group'          => 'advanced',
				'label'          => esc_html__( 'This is a message', 'omnisend-for-ninja-forms' ),
				'value'          => "<div class='omnisend-ninja-forms-having-trouble'><div class='omnisend-ninja-forms-having-trouble-heading'>" . esc_html__( 'Having trouble? Explore our help article', 'omnisend-for-ninja-forms' ) . "</div><div><a class='omnisend-ninja-forms-link' href='#'>" . esc_html__( 'Learn more', 'omnisend-for-ninja-forms' ) . '</a></div> </div>',
				'width'          => 'full',
				'use_merge_tags' => true,
			),
		);
